 ...
 *
 */
public class ADAPT2GroupSN_VizShade implements
...
//		System.out.println("~~~ res=" + _item.toString() + " val1=" + val1 + " val2=" + val2);
		...
		else if(_educ_level>val2)
		{
			...
			icon2_ind_desc = "<strong>Dark Green </strong> shade means <strong>great progress</strong> " + 
					"(actual value " + formatter.format(_educ_level) + " interactions with this resource.)";
			individ_status = "4";
			individ_summary = "4/4";
		}
		...
		else if(_educ_level>val1)
		{
			...
			icon2_ind_desc = "<strong>Light Green</strong> shade means <strong>medium progress</strong> " + 
					"(actual value " + formatter.format(_educ_level) + " interactions with this resource.)";
			individ_status = "2";
			individ_summary = "2/4";
		}
		else if(_educ_level>0)
		{
			...
			icon2_ind_desc = "<strong>Very Light Green</strong> shade means <strong>fair progress</strong> " + 
					"(actual value " + formatter.format(_educ_level) + " interactions with this resource.)";
			individ_status = "1";
			individ_summary = "1/4";
		}
		else
		{
			...
			icon2_ind_desc = "<strong>White</strong> shade means <strong>minimal to zero progress</strong> " + 
					"(actual value " + formatter.format(_educ_level) + " interactions with this resource.)";
			individ_status = "0";
			individ_summary = "0/4";
		}
