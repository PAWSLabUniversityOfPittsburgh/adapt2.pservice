 ...
 *
 */
public class SimADAPT2SocialNavigationPService_PortalVisualizer2_StudentOnly implements
...
//		icon2_html = "<span style='background-color:" + icon2_style + ";padding:3px;' ><a " + m_in_out + "><img style='vertical-align:text-bottom;' src='" + icon2 + "' border='0'/></a></span><span style='display:none' id='textToolTip" + n_rand + "'>" + icon2_ind_desc + icon2_grp_desc + "</span>";
        // Student Only
		icon2_html = "<span><a " + m_in_out + "><img style='vertical-align:text-bottom;' src='" + icon2 + "' border='0'/></a></span><span style='display:none' id='textToolTip" + n_rand + "'>" + icon2_ind_desc + "</span>";
