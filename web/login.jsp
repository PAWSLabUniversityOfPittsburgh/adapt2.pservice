...
<title>ADAPT&sup2; Personalization Services - Login</title>
...
<form action="j_security_check" method="POST">
	<table cellpadding='2px' cellspacing='0px' class='dkcyan_table' width='320px' align="center">
		<caption class='dkcyan_table_caption'>ADAPT&sup2; Personalization Services - Login</caption>
		<tr><td colspan="2">To access PServices enter your credentials</td></tr>
		<tr> 
